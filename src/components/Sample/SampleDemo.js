              ...
              <div className="p-grid">
                  ...
                  <div className="p-grid">
                    <div className="p-col-12">
                      <Checkbox
                        ...
                        checked={
                          this.state.checkboxValue.indexOf("Ultima") > -1
                        }
                      />
                    ...
                    <div className="p-col-12">
                      <Checkbox
                        ...
                        onChange={this.onCheckboxChange}
                        checked={
                          this.state.checkboxValue.indexOf("Avalon") > -1
                        }
                      />
                    ...
                    <div className="p-col-12">
                      <Checkbox
                        ...
                        onChange={this.onCheckboxChange}
                        checked={
                          this.state.checkboxValue.indexOf("Serenity") > -1
                        }
                      />
                ...
                <div className="p-col-12 p-md-4">
                  <MultiSelect
                    ...
                    onChange={event =>
                      this.setState({ selectedCars: event.value })
                    }
                  />
                </div>
